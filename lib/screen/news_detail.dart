...
class NewsDetail extends StatefulWidget {
  ...
  @override
  _NewsDetailState createState() => _NewsDetailState(article: article);
}
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          AspectRatio(
            aspectRatio: 16/9,
            child: FadeInImage.assetNetwork(placeholder: 'assets/img/placeholder.png', image: article.img,fit: BoxFit.cover,),
          ),
          Container(
